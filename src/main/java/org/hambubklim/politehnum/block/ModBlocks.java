...
public class ModBlocks {
    ...
    public static final Block DEEPSLATE_POLITEHNUM_ORE = registerBlock("deepslate_politehnum_ore",
    ...
    public static final Block END_STONE_POLITEHNUM_ORE = registerBlock("end_stone_politehnum_ore",
