...
public enum ModArmorMaterials implements ArmorMaterial {
    POLITEHNUM("politehnum",45,new int[] {4,10,7,4},19, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,4f,0.2f,()->Ingredient.ofItems(ModItems.POLITEHNUM));
    ;
    ...
    public String getName() {
        return Politehnum.MOD_ID + ":" + this.name;
    }
